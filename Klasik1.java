...
public class Klasik1 extends JFrame {
    ...
    public Klasik1() {
        setTitle("Klasik Oyun - 1");     //JFrame adı
        ...
        otMaze = new JButton("2. Labirente Geç");
        ...
        otMaze.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Klasik2 k = new Klasik2();
                try {
                    k.labYap();
                } catch (IOException ex) {
                    Logger.getLogger(Klasik1.class.getName()).log(Level.SEVERE, null, ex);
                }
                ekranKapa();
                k.setVisible(true);
            }
    ...
    public boolean isFinal(int i, int j) {
        ...
        return (i == Klasik1.END_I && j == Klasik1.END_J);
    }
